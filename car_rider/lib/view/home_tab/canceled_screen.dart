...
class CanceledRides extends StatefulWidget {
  const CanceledRides({Key? key}) : super(key: key);

  @override
  State<CanceledRides> createState() => _CanceledRidesState();
}

class _CanceledRidesState extends State<CanceledRides> {
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Container(
                                ...
                                decoration: myFillBoxDecoration(1, Colors.red, 11),
                                child: Text("Cancled")),
                          ],
                        ),
                      ),
